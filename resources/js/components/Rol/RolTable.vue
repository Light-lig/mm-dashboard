        ...
        <table class="table table-striped table-hover mt-3 shadow">
            ...
            <tbody v-if="data">
                ...
                <tr v-for="(value, index) in data" :key="value.id">
                    ...
                    <td>
                        <div v-if="value.permissions.length > 0">
                            <span
                                class="badge bg-primary m-1 fs-6"
                                v-for="p in value.permissions"
                                :key="p.id"
                                >{{ p.name }}</span
                            >
                        </div>
                        <span
                            class="badge bg-secondary m-1 fs-6"
                            v-if="value.permissions.length == 0"
